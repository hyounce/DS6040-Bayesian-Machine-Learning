...
Based on the results of the Gibbs sampler, for a given year k the expected value of the rate of coal mining accidents from years 1 to k is 3.03, and there is a 95% probability that an unobserved mu value will fall into the interval (2.54, 3.62). Likewise, for a given year k the expected value of the rate of coal mining accidents from years k+1 to 112 is 0.92, and there is a 95% probability that an unobserved lambda value will fall into the interval (0.71, 1.18). 
